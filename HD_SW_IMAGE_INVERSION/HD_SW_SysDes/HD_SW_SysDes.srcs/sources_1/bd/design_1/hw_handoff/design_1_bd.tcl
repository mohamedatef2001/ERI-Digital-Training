...
proc create_root_design { parentCell } {
  ...
  # Create instance: send_recive_image_0, and set properties
  set send_recive_image_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:send_recive_image:1.0 send_recive_image_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins send_recive_image_0/s_axis]
